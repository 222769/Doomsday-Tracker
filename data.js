...
//   connectsTo     - optional string naming the next title this one leads
//                    into — shown as a small "leads into" line on the card,
//                    always visible (not a spoiler, since it's just a
//                    title). Only set where there's a genuine, specific
//                    forward link; left off self-contained entries rather
//                    than forcing one on everything.
...
export const sections = [
  ...
  { id: "side-quests", title: "Optional Side Quests", description: "Side content that doesn't feed into Doomsday directly — switch on to include.", range: [71, 107] },
];
...
export const items = [
  ...
  },
  {
    ...
    connectsTo: "The Punisher (Season 1)",
    episodes: [
  ...
  },
  {
    ...
    connectsTo: "The Punisher: One Last Kill",
    episodes: [
  ...
  },
  {
    ...
    connectsTo: "Doctor Strange in the Multiverse of Madness",
    episodes: [
  ...
  { id: "captain-america-brave-new-world", title: "Captain America: Brave New World", type: "movie", releaseOrder: 60, timelineOrder: 62, section: "final-run", core: true, runtimeMinutes: 118, connectsTo: "Thunderbolts*" },
  {
    ...
    connectsTo: "Daredevil: Born Again (Season 2)",
    episodes: [
  ...
  { id: "spider-man-2002", title: "Spider-Man", type: "movie", releaseOrder: 71, timelineOrder: 71, section: "side-quests", optional: true, runtimeMinutes: 121, notes: "Optional side quest. Opens Sam Raimi's Spider-Man trilogy — this era resurfaces briefly in No Way Home's multiverse crossover, but isn't required to get there.", connectsTo: "Spider-Man: No Way Home" },
  { id: "spider-man-2-2004", title: "Spider-Man 2", type: "movie", releaseOrder: 72, timelineOrder: 72, section: "side-quests", optional: true, runtimeMinutes: 127, notes: "Optional side quest. The second entry in Raimi's trilogy.", connectsTo: "Spider-Man: No Way Home" },
  { id: "spider-man-3-2007", title: "Spider-Man 3", type: "movie", releaseOrder: 73, timelineOrder: 73, section: "side-quests", optional: true, runtimeMinutes: 139, notes: "Optional side quest. Closes out Raimi's trilogy.", connectsTo: "Spider-Man: No Way Home" },
  { id: "amazing-spider-man", title: "The Amazing Spider-Man", type: "movie", releaseOrder: 74, timelineOrder: 74, section: "side-quests", optional: true, runtimeMinutes: 136, notes: "Optional side quest. Opens the Garfield-era duology, also touched on by No Way Home's crossover.", connectsTo: "Spider-Man: No Way Home" },
  { id: "amazing-spider-man-2", title: "The Amazing Spider-Man 2", type: "movie", releaseOrder: 75, timelineOrder: 75, section: "side-quests", optional: true, runtimeMinutes: 142, notes: "Optional side quest. Closes out the Garfield-era duology.", connectsTo: "Spider-Man: No Way Home" },
  { id: "x-men-origins-wolverine", title: "X-Men Origins: Wolverine", type: "movie", releaseOrder: 76, timelineOrder: 76, section: "side-quests", optional: true, runtimeMinutes: 107, notes: "Optional side quest. A Wolverine solo prequel set within Fox's original X-Men continuity.", connectsTo: "Deadpool & Wolverine" },
  { id: "x-men-first-class", title: "X-Men: First Class", type: "movie", releaseOrder: 77, timelineOrder: 77, section: "side-quests", optional: true, runtimeMinutes: 131, notes: "Optional side quest. A prequel reboot of the X-Men series — not required to follow the main line.", connectsTo: "Deadpool & Wolverine" },
  { id: "the-wolverine", title: "The Wolverine", type: "movie", releaseOrder: 78, timelineOrder: 78, section: "side-quests", optional: true, runtimeMinutes: 126, notes: "Optional side quest. Wolverine's second solo outing.", connectsTo: "Deadpool & Wolverine" },
  { id: "x-men-apocalypse", title: "X-Men: Apocalypse", type: "movie", releaseOrder: 79, timelineOrder: 79, section: "side-quests", optional: true, runtimeMinutes: 144, notes: "Optional side quest. Closes out the First Class prequel trilogy.", connectsTo: "Deadpool & Wolverine" },
  { id: "dark-phoenix", title: "Dark Phoenix", type: "movie", releaseOrder: 80, timelineOrder: 80, section: "side-quests", optional: true, runtimeMinutes: 113, notes: "Optional side quest. The final film of the pre-reboot X-Men series.", connectsTo: "Deadpool & Wolverine" },
  { id: "the-new-mutants", title: "The New Mutants", type: "movie", releaseOrder: 81, timelineOrder: 81, section: "side-quests", optional: true, runtimeMinutes: 94, notes: "Optional side quest. A standalone, horror-tinged spinoff only loosely tied to the wider X-Men series.", connectsTo: "Deadpool & Wolverine" },
  {
  ...
  },
  {
    ...
    episodes: [
      ...
      { id: "agent-carter-season-1-e3", title: "Episode 3", runtimeMinutes: 43 },
      { id: "agent-carter-season-1-e4", title: "Episode 4", runtimeMinutes: 43 },
      { id: "agent-carter-season-1-e5", title: "Episode 5", runtimeMinutes: 43 },
      { id: "agent-carter-season-1-e6", title: "Episode 6", runtimeMinutes: 43 },
      { id: "agent-carter-season-1-e7", title: "Episode 7", runtimeMinutes: 43 },
      { id: "agent-carter-season-1-e8", title: "Episode 8", runtimeMinutes: 43 },
    ],
  },
  {
    id: "agent-carter-season-2", title: "Agent Carter (Season 2)", type: "show", releaseOrder: 98, timelineOrder: 98, section: "side-quests", optional: true,
    notes: "Optional side quest. Season 2 moves the setting to 1947 Los Angeles.",
    episodes: [
      { id: "agent-carter-season-2-e1", title: "Episode 1", runtimeMinutes: 43 },
      { id: "agent-carter-season-2-e2", title: "Episode 2", runtimeMinutes: 43 },
      { id: "agent-carter-season-2-e3", title: "Episode 3", runtimeMinutes: 43 },
      { id: "agent-carter-season-2-e4", title: "Episode 4", runtimeMinutes: 43 },
      { id: "agent-carter-season-2-e5", title: "Episode 5", runtimeMinutes: 43 },
      { id: "agent-carter-season-2-e6", title: "Episode 6", runtimeMinutes: 43 },
      { id: "agent-carter-season-2-e7", title: "Episode 7", runtimeMinutes: 43 },
      { id: "agent-carter-season-2-e8", title: "Episode 8", runtimeMinutes: 43 },
      { id: "agent-carter-season-2-e9", title: "Episode 9", runtimeMinutes: 43 },
      { id: "agent-carter-season-2-e10", title: "Episode 10", runtimeMinutes: 43 },
    ],
  },
  {
    ...
    episodes: [
      ...
      { id: "marvel-one-shots-e3", title: "Item 47", runtimeMinutes: 12 },
      { id: "marvel-one-shots-e4", title: "Agent Carter", runtimeMinutes: 15 },
      { id: "marvel-one-shots-e5", title: "All Hail the King", runtimeMinutes: 15 },
    ],
  },
  { id: "werewolf-by-night", title: "Werewolf by Night", type: "movie", releaseOrder: 100, timelineOrder: 100, section: "side-quests", optional: true, runtimeMinutes: 53, notes: "Optional side quest. A black-and-white Halloween special introducing Jack Russell and Elsa Bloodstone." },
  { id: "guardians-holiday-special", title: "The Guardians of the Galaxy Holiday Special", type: "movie", releaseOrder: 101, timelineOrder: 101, section: "side-quests", optional: true, runtimeMinutes: 44, notes: "Optional side quest. A standalone Christmas special bridging Vol. 2 and Vol. 3." },
  {
    id: "i-am-groot", title: "I Am Groot", type: "show", releaseOrder: 102, timelineOrder: 102, section: "side-quests", optional: true,
    notes: "Optional side quest. A collection of animated shorts following Baby Groot — short titles weren't confirmed as of this list's last update, shown as placeholders.",
    episodes: [
      { id: "i-am-groot-e1", title: "Short 1", runtimeMinutes: 5 },
      { id: "i-am-groot-e2", title: "Short 2", runtimeMinutes: 5 },
      { id: "i-am-groot-e3", title: "Short 3", runtimeMinutes: 5 },
      { id: "i-am-groot-e4", title: "Short 4", runtimeMinutes: 5 },
      { id: "i-am-groot-e5", title: "Short 5", runtimeMinutes: 5 },
      { id: "i-am-groot-e6", title: "Short 6", runtimeMinutes: 5 },
      { id: "i-am-groot-e7", title: "Short 7", runtimeMinutes: 5 },
      { id: "i-am-groot-e8", title: "Short 8", runtimeMinutes: 5 },
      { id: "i-am-groot-e9", title: "Short 9", runtimeMinutes: 5 },
      { id: "i-am-groot-e10", title: "Short 10", runtimeMinutes: 5 },
    ],
  },
  {
    id: "eyes-of-wakanda", title: "Eyes of Wakanda", type: "show", releaseOrder: 103, timelineOrder: 103, section: "side-quests", optional: true,
    notes: "Optional side quest. An animated anthology tracing Wakandan history across the centuries — episode titles weren't confirmed as of this list's last update, shown as placeholders.",
    episodes: [
      { id: "eyes-of-wakanda-e1", title: "Episode 1", runtimeMinutes: 30 },
      { id: "eyes-of-wakanda-e2", title: "Episode 2", runtimeMinutes: 30 },
      { id: "eyes-of-wakanda-e3", title: "Episode 3", runtimeMinutes: 30 },
      { id: "eyes-of-wakanda-e4", title: "Episode 4", runtimeMinutes: 30 },
    ],
  },
  {
    id: "marvel-zombies", title: "Marvel Zombies", type: "show", releaseOrder: 104, timelineOrder: 104, section: "side-quests", optional: true,
    notes: "Optional side quest. An animated, alternate-timeline horror take on the MCU roster — episode titles weren't confirmed as of this list's last update, shown as placeholders.",
    episodes: [
      { id: "marvel-zombies-e1", title: "Episode 1", runtimeMinutes: 35 },
      { id: "marvel-zombies-e2", title: "Episode 2", runtimeMinutes: 35 },
      { id: "marvel-zombies-e3", title: "Episode 3", runtimeMinutes: 35 },
      { id: "marvel-zombies-e4", title: "Episode 4", runtimeMinutes: 35 },
    ],
  },
  {
    id: "x-men-97-season-1", title: "X-Men '97 (Season 1)", type: "show", releaseOrder: 105, timelineOrder: 105, section: "side-quests", optional: true,
    notes: "Optional side quest. An animated revival continuing the '90s X-Men: The Animated Series continuity — episode titles weren't confirmed as of this list's last update, shown as placeholders.",
    episodes: [
      { id: "x-men-97-season-1-e1", title: "Episode 1", runtimeMinutes: 24 },
      { id: "x-men-97-season-1-e2", title: "Episode 2", runtimeMinutes: 24 },
      { id: "x-men-97-season-1-e3", title: "Episode 3", runtimeMinutes: 24 },
      { id: "x-men-97-season-1-e4", title: "Episode 4", runtimeMinutes: 24 },
      { id: "x-men-97-season-1-e5", title: "Episode 5", runtimeMinutes: 24 },
      { id: "x-men-97-season-1-e6", title: "Episode 6", runtimeMinutes: 24 },
      { id: "x-men-97-season-1-e7", title: "Episode 7", runtimeMinutes: 24 },
      { id: "x-men-97-season-1-e8", title: "Episode 8", runtimeMinutes: 24 },
      { id: "x-men-97-season-1-e9", title: "Episode 9", runtimeMinutes: 24 },
      { id: "x-men-97-season-1-e10", title: "Episode 10", runtimeMinutes: 33 },
    ],
  },
  {
    id: "x-men-97-season-2", title: "X-Men '97 (Season 2)", type: "show", releaseOrder: 106, timelineOrder: 106, section: "side-quests", optional: true,
    notes: "Optional side quest. Continues directly from Season 1 — episode count and titles hadn't been announced as of this list's last update, shown as placeholders.",
    episodes: [
      { id: "x-men-97-season-2-e1", title: "Episode 1", runtimeMinutes: 24 },
      { id: "x-men-97-season-2-e2", title: "Episode 2", runtimeMinutes: 24 },
      { id: "x-men-97-season-2-e3", title: "Episode 3", runtimeMinutes: 24 },
      { id: "x-men-97-season-2-e4", title: "Episode 4", runtimeMinutes: 24 },
      { id: "x-men-97-season-2-e5", title: "Episode 5", runtimeMinutes: 24 },
      { id: "x-men-97-season-2-e6", title: "Episode 6", runtimeMinutes: 24 },
      { id: "x-men-97-season-2-e7", title: "Episode 7", runtimeMinutes: 24 },
      { id: "x-men-97-season-2-e8", title: "Episode 8", runtimeMinutes: 24 },
      { id: "x-men-97-season-2-e9", title: "Episode 9", runtimeMinutes: 24 },
      { id: "x-men-97-season-2-e10", title: "Episode 10", runtimeMinutes: 24 },
    ],
  },
  {
    id: "your-friendly-neighborhood-spider-man", title: "Your Friendly Neighborhood Spider-Man", type: "show", releaseOrder: 107, timelineOrder: 107, section: "side-quests", optional: true,
    notes: "Optional side quest. An animated series following a teenage Peter Parker — episode count and titles hadn't been announced as of this list's last update, shown as placeholders.",
    episodes: [
      { id: "your-friendly-neighborhood-spider-man-e1", title: "Episode 1", runtimeMinutes: 24 },
      { id: "your-friendly-neighborhood-spider-man-e2", title: "Episode 2", runtimeMinutes: 24 },
      { id: "your-friendly-neighborhood-spider-man-e3", title: "Episode 3", runtimeMinutes: 24 },
      { id: "your-friendly-neighborhood-spider-man-e4", title: "Episode 4", runtimeMinutes: 24 },
      { id: "your-friendly-neighborhood-spider-man-e5", title: "Episode 5", runtimeMinutes: 24 },
      { id: "your-friendly-neighborhood-spider-man-e6", title: "Episode 6", runtimeMinutes: 24 },
      { id: "your-friendly-neighborhood-spider-man-e7", title: "Episode 7", runtimeMinutes: 24 },
      { id: "your-friendly-neighborhood-spider-man-e8", title: "Episode 8", runtimeMinutes: 24 },
      { id: "your-friendly-neighborhood-spider-man-e9", title: "Episode 9", runtimeMinutes: 24 },
      { id: "your-friendly-neighborhood-spider-man-e10", title: "Episode 10", runtimeMinutes: 24 },
    ],
  },
];
