...
export const items = [
  ...
  { id: "wandavision", title: "WandaVision", type: "show", releaseOrder: 24, timelineOrder: 26, runtimeMinutes: 340, notes: "9 episodes. Sets up Wanda's arc for Doctor Strange in the Multiverse of Madness." },
  { id: "falcon-and-winter-soldier", title: "The Falcon and the Winter Soldier", type: "show", releaseOrder: 25, timelineOrder: 27, runtimeMinutes: 300, notes: "6 episodes. Sam Wilson takes up the Captain America shield." },
  { id: "loki-season-1", title: "Loki (Season 1)", type: "show", releaseOrder: 26, timelineOrder: 24, runtimeMinutes: 300, notes: "6 episodes. Branches the multiverse — required viewing for everything that follows." },
  ...
  { id: "what-if", title: "What If...? (Seasons 1-3)", type: "show", releaseOrder: 28, timelineOrder: 25, runtimeMinutes: 890, notes: "28 episodes across 3 seasons. Animated anthology exploring alternate timelines.", stopPoint: "widely considered optional — most viewers skip it entirely except episodes that tie into live-action events" },
  ...
  { id: "hawkeye", title: "Hawkeye", type: "show", releaseOrder: 31, timelineOrder: 31, runtimeMinutes: 270, notes: "6 episodes. Introduces Kate Bishop." },
  ...
  { id: "moon-knight", title: "Moon Knight", type: "show", releaseOrder: 33, timelineOrder: 38, runtimeMinutes: 290, notes: "6 episodes. Self-contained — minimal ties to the wider saga so far." },
  ...
  { id: "ms-marvel", title: "Ms. Marvel", type: "show", releaseOrder: 35, timelineOrder: 40, runtimeMinutes: 230, notes: "6 episodes. Sets up Kamala Khan ahead of The Marvels." },
  { id: "thor-love-and-thunder", title: "Thor: Love and Thunder", type: "movie", releaseOrder: 36, timelineOrder: 41, runtimeMinutes: 119 },
  { id: "she-hulk", title: "She-Hulk: Attorney at Law", type: "show", releaseOrder: 37, timelineOrder: 42, runtimeMinutes: 300, notes: "9 episodes. Mostly self-contained; the finale breaks the fourth wall." },
  ...
  { id: "secret-invasion", title: "Secret Invasion", type: "show", releaseOrder: 41, timelineOrder: 44, runtimeMinutes: 240, notes: "6 episodes. Establishes the Skrull infiltration thread.", stopPoint: "if short on time, the finale (S1E6) is the only essential episode" },
  { id: "loki-season-2", title: "Loki (Season 2)", type: "show", releaseOrder: 42, timelineOrder: 47, runtimeMinutes: 300, notes: "6 episodes. Resolves the TVA storyline and reshapes the multiverse's branches." },
  { id: "the-marvels", title: "The Marvels", type: "movie", releaseOrder: 43, timelineOrder: 48, runtimeMinutes: 105 },
  { id: "echo", title: "Echo", type: "show", releaseOrder: 44, timelineOrder: 49, runtimeMinutes: 190, notes: "5 episodes. Follow-up to Hawkeye's Kingpin/Maya Lopez thread." },
  ...
  { id: "agatha-all-along", title: "Agatha All Along", type: "show", releaseOrder: 46, timelineOrder: 64, runtimeMinutes: 400, notes: "9 episodes. WandaVision spinoff following Agatha Harkness." },
  ...
  { id: "daredevil-born-again", title: "Daredevil: Born Again", type: "show", releaseOrder: 48, timelineOrder: 65, runtimeMinutes: 450, notes: "9 episodes. Wilson Fisk's rise sets up the political thread running through Thunderbolts*." },
  { id: "thunderbolts", title: "Thunderbolts*", type: "movie", releaseOrder: 49, timelineOrder: 67, runtimeMinutes: 126 },
  { id: "ironheart", title: "Ironheart", type: "show", releaseOrder: 50, timelineOrder: 68, runtimeMinutes: 225, notes: "6 episodes. Introduces Riri Williams ahead of her expected role in the wider saga." },
